...
\subsection{CPU vs. GPU speedup}
	...
	\begin{equation}
		G_{i j k}(\mathbf{r}, \alpha, \mathbf{A})=x_{A}^{i} y_{A}^{j} z_{A}^{k} \exp \left(-\alpha r_{A}^{2}\right)
	\end{equation}
